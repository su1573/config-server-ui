<template>
    <div class="sidebar">
        <el-menu :default-active="onRoutes" class="el-menu-vertical-demo" theme="dark" unique-opened router>
            ...
            <el-submenu index="4">
                <template slot="title">
                    <i class="el-icon- fa fa-cog"></i>项目及环境</template>
                <el-menu-item index="/profile">
                    <i class="fa fa-terminal"></i> Profile</el-menu-item>
                <el-menu-item index="/label">
                    <i class="fa fa-tags"></i> Label </el-menu-item>
                <el-menu-item index="/application">
                    <i class="fa fa-paper-plane-o"></i> Appication</el-menu-item>
            </el-submenu>
            <el-submenu index="5">
                <template slot="title">
                    <i class="el-icon- fa fa-file-text"></i>配置管理</template>
                <el-menu-item index="/property">
                    <i class="fa fa-file-text-o"></i> Property</el-menu-item>
            </el-submenu>
            <el-submenu index="6">
                <template slot="title">
